...
from adaptive_reservoir.core.diagnostics import TraceNorms
...
class StepMetrics:
    ...
    def __post_init__(self) -> None:
        ...
        if self.trace_norms is not None:
            _validate_optional_non_negative("trace_norms.fast", self.trace_norms.fast)
            _validate_optional_non_negative("trace_norms.mid", self.trace_norms.mid)
            _validate_optional_non_negative("trace_norms.slow", self.trace_norms.slow)
