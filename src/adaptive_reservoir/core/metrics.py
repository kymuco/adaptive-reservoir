"""Aggregate runtime metrics for the high-level reservoir facade."""
...
class AdaptiveReservoirMetricsSnapshot:
    """Immutable aggregate runtime metrics for an AdaptiveReservoir instance."""
    ...
    def __post_init__(self) -> None:
        ...
        _validate_non_negative_float("us_per_sample_avg", self.us_per_sample_avg)
        ...
        if self.readout_update_count > self.samples_seen:
            msg = "readout_update_count must not exceed samples_seen"
